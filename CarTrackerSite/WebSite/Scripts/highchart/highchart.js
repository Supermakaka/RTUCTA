...
(function() {
    ...
    var G, Z = document,
        ...
        wa = !!Z.createElementNS &&
        !!Z.createElementNS(Na, "svg").createSVGRect,
        ...
        fb = 0,
        ic = /^[0-9]+$/,
        ua, lb, Pa, yb, zb, Ab, Wa, mb, nb, Qb, Rb, Bb, Sb, Tb, P = {},
        ga;
    ...
    Eb = {
        init: function(a, b, c) {
            ...
            a.shift = 0;
            if (b.length)
                for (a = c.length; b.length <
                    a;) d = [].concat(b).splice(b.length - f, f), e && (d[f - 6] = d[f - 2], d[f - 5] = d[f - 1]), b = b.concat(d);
    ...
    ia.prototype = {
        ...
        animate: function(a, b, c) {
            b = p(b, La, !0);
            gb(this);
            b ? (b = E(b, {}), c && (b.complete = c), sb(this,
                a, b)) : (this.attr(a), c && c());
            return this
        },
        ...
        attr: function(a, b) {
            ...
            if ("string" ===
                typeof a) g = (this[a + "Getter"] || this._defaultGetter).call(this, a, e);
            else {
        ...
        addClass: function(a) {
            var b = this.element,
                c = C(b, "class") || ""; - 1 === c.indexOf(a) && C(b, "class", c + " " + a);
            return this
        },
        ...
        css: function(a) {
            ...
            if (e) {
                e = this.textWidth =
                    a && a.width && "text" === d.nodeName.toLowerCase() && O(a.width);
                b && (a = n(b, c));
                this.styles = a;
        ...
        on: function(a, b) {
            ...
            db && "click" === a ? (d.ontouchstart = function(a) {
                ...
                (-1 ===
                    Ma.indexOf("Android") || 1100 < ua.now() - (c.touchEventFired || 0)) && b.call(d, a)
            }) : d["on" + a] = b;
            return this
        },
        ...
        align: function(a, b, c) {
            ...
            f = e.alignedObjects;
            if (a) {
                if (this.alignOptions = a, this.alignByTranslate = b, !c || Y(c)) this.alignTo = d = c || "renderer", y(f,
        ...
        getBBox: function() {
            ...
            if (!a) {
                ...
                b.isSVG && (c = a.width, d = a.height, Oa && f && "11px" === f.fontSize && "16.9" === d.toPrecision(3) && (a.height = d = 14),
                    e && (a.width = ka(d * ya(g)) + ka(c * xa(g)), a.height = ka(d * xa(g)) + ka(c * ya(g))));
                this.bBox = a;
                h && (b.cache[h] = a)
            }
            return a
        ...
        destroy: function() {
            var a = this,
                b = a.element || {},
                c = a.shadows,
                d = a.renderer.isSVG && "SPAN" ===
                b.nodeName && a.parentGroup,
                e, f;
        ...
        titleSetter: function(a) {
            ...
            b ||
                (b = Z.createElementNS(Na, "title"), this.element.appendChild(b));
    ...
    ia.prototype.translateXSetter =
        ia.prototype.translateYSetter = ia.prototype.rotationSetter = ia.prototype.verticalAlignSetter = ia.prototype.scaleXSetter = ia.prototype.scaleYSetter = function(a, b) {
            this[b] = a;
            this.doTransform = !0
        };
    ia.prototype["stroke-widthSetter"] = ia.prototype.strokeSetter = function(a, b, c) {
        this[b] = a;
        this.stroke && this["stroke-width"] ? (this.strokeWidth = this["stroke-width"], ia.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0) : "stroke-width" === b && 0 ===
            a && this.hasStroke && (c.removeAttribute("stroke"), this.hasStroke = !1)
    };
    var Ca = function() {
        this.init.apply(this, arguments)
    };
    Ca.prototype = {
        ...
        init: function(a, b, c, d, e) {
            ...
            g = d.element;
            a.appendChild(g); - 1 === a.innerHTML.indexOf("xmlns") && C(g, "xmlns", Na);
            this.isSVG = !0;
            this.box = g;
            this.boxWrapper = d;
            this.alignedObjects = [];
            this.url = (cb || Cb) && Z.getElementsByTagName("base").length ? f.href.replace(/#.*?$/, "").replace(/([\('\)])/g,
                "\\$1").replace(/ /g, "%20") : "";
        ...
        buildText: function(a) {
            ...
            f || x || -1 !== e.indexOf(" ") ? (h = /<.*style="([^"]+)".*>/, m = /<.*href="(http[^"]+)".*>/, v && !a.added && this.box.appendChild(b),
                e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], "" === e[e.length - 1] && e.pop(), D(e, function(e, f) {
                    var g, z = 0;
        ...
        button: function(a, b, c, d, e, f, g, h, m) {
            var q = this.label(a,
                    b, c, m, null, null, null, null, "button"),
                r = 0,
                v, z, x, H, p, k;
            a = {
                x1: 0,
        ...
        symbols: {
            ...
            callout: function(a, b, c, d, e) {
                ...
                h && h > c && m > b + g && m < b + d - g ? e.splice(13, 3, "L", a + c, m - 6, a + c + 6, m, a + c, m + 6, a + c, b + d - f) : h && 0 > h && m > b + g && m < b + d - g ? e.splice(33, 3, "L", a, m + 6, a - 6, m, a, m - 6, a, b + f) : m && m > d && h > a + g && h < a + c - g ? e.splice(23, 3, "L", h + 6, b + d, h, b + d + 6, h - 6, b + d, a + f, b + d) : m && 0 > m && h > a + g && h < a + c - g && e.splice(3, 3, "L", h - 6, b, h, b -
                    6, h + 6, b, c - f, b);
                return e
            }
        },
    ...
    n(ia.prototype, {
        ...
        setSpanRotation: function(a, b, c) {
            var d = {},
                e = Oa ? "-ms-transform" : Cb ? "-webkit-transform" : cb ? "MozTransform" : Vb ? "-o-transform" : "";
        ...
        Sa = {
            ...
            clip: function(a) {
                var b = this,
                    c;
                a ? (c = a.members,
                    y(c, b), c.push(b), b.destroyClip = function() {
                        y(c, b)
        ...
        var pc = {
            ...
            color: function(a, b, c, d) {
                var e = this,
                    f, g = /^rgba/,
                    h, m, q = "none";
                a && a.linearGradient ? m = "gradient" : a && a.radialGradient &&
                    (m = "pattern");
                if (m) {
                    ...
                    if ("fill" === c)
                        if ("gradient" ===
                            m) c = z.x1 || z[0] || 0, a = z.y1 || z[1] || 0, x = z.x2 || z[2] || 0, z = z.y2 || z[3] || 0, l = 'angle="' + (90 - 180 * la.atan((z - a) / (x - c)) / Ea) + '"', F();
                        else {
                            var q = z.r,
                                n = 2 * q,
                                B = 2 * q,
                ...
                } else g.test(a) && "IMG" !== b.tagName ? (f = Ja(a),
                    h = ["<", c, ' opacity="', f.get("a"), '"/>'], K(this.prepVML(h), null, null, b), q = f.get("rgb")) : (q = b.getElementsByTagName(c), q.length && (q[0].opacity = 1, q[0].type = "solid"), q = a);
                return q
            },
            prepVML: function(a) {
                var b = this.isIE8;
    ...
    Ca.prototype.measureSpanWidth = function(a,
        b) {
    ...
    ra.prototype = {
        ...
        getLabelSize: function() {
            var a = this.label,
                b = this.axis;
            return a ? a.getBBox()[b.horiz ? "height" : "width"] :
                0
        },
        ...
        getPosition: function(a, b, c, d) {
            ...
            return {
                ...
                y: a ? g - e.bottom + e.offset - (e.opposite ?
                    e.height : 0) : g - e.translate(b + c, null, null, d) - e.transB
            }
        },
        ...
        render: function(a, b, c) {
            ...
            if (H && (q = d.getPlotLinePath(q + B, H * y, b, !0), v === G && (v = {
                        stroke: k,
                        "stroke-width": H
                    }, t && (v.dashstyle = t), h || (v.zIndex = 1), b && (v.opacity = 0), this.gridLine = v = H ? f.path(q).attr(v).add(d.gridGroup) :
                    null), !b && v && q)) v[this.isNew ? "attr" : "animate"]({
                d: q,
                opacity: c
            });
            ...
            m && !isNaN(R) && (m.xy = D = this.getLabelPosition(R, D, m, g, r, B, a, F), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? n = !1 : d.isRadial || r.step || r.rotation || b || 0 === c || (n = this.handleOverflow(a, D)), F && a % F &&
                (n = !1), n && !isNaN(D.y) ? (D.opacity = c, m[this.isNew ? "attr" : "animate"](D), this.isNew = !1) : m.attr("y", -9999))
        },
        destroy: function() {
            ca(this, this.axis)
        }
    ...
    T.prototype = {
        ...
        init: function(a, b) {
            ...
            var f, d = this.options.events; - 1 === Ra(this, a.axes) && (c && !this.isColorAxis ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this), a[this.coll].push(this));
        ...
        adjustForMinRange: function() {
            ...
            if (c - b < this.minRange) {
                ...
                c = ea(c);
                c - b < r &&
                    (d[0] = c - r, d[1] = p(a.min, c - r), b = Ia(d))
            }
            this.min = b;
            this.max = c
        },
        setAxisTranslation: function(a) {
            ...
            if (b.isXAxis || m || d) h ? (f = h.minPointOffset, g = h.pointRangePadding) : D(b.series, function(a) {
                ...
                e ? b.ordinalSlope / e : 1, b.minPointOffset = f *= h, b.pointRangePadding = g *= h, b.pointRange = U(d, c), b.closestPointRange = e;
            a && (b.oldTransA = q);
        ...
        setTickPositions: function(a) {
            ...
            b.adjustForMinRange();
            !(l || b.axisPointRange || b.usePercentage ||
                q) && u(b.min) && u(b.max) && (c = b.max - b.min) && (u(d.min) || u(b.userMin) || !z || !(0 > b.dataMin) && b.ignoreMinPadding || (b.min -= c * z), u(d.max) || u(b.userMax) || !v || !(0 < b.dataMax) && b.ignoreMaxPadding || (b.max += c * v));
            aa(d.floor) && (b.min = N(b.min, d.floor));
            aa(d.ceiling) && (b.max = U(b.max, d.ceiling));
            b.min === b.max || void 0 === b.min || void 0 === b.max ? b.tickInterval = 1 : q && !x && k === b.linkedParent.options.tickPixelInterval ? b.tickInterval = b.linkedParent.tickInterval : (b.tickInterval = p(x, l ? 1 : (b.max - b.min) * k / N(b.len, k)), !u(x) && b.len < k &&
                !this.isRadial && !this.isLog && !l && e && f && (t = !0, b.tickInterval /= 4));
            ...
            h || g || x || (b.tickInterval = R(b.tickInterval, null, F(b.tickInterval), p(d.allowDecimals, !(1 <
                b.tickInterval && 5 > b.tickInterval && 1E3 < b.max && 9999 > b.max))));
            ...
            a || (!b.ordinalPositions && (b.max - b.min) / b.tickInterval > N(2 * b.len, 200) && Aa(19, !0), a = h ? b.getTimeTicks(b.normalizeTimeTickInterval(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, !0) : g ? b.getLogTickPositions(b.tickInterval,
                b.min, b.max) : b.getLinearTickPositions(b.tickInterval, b.min, b.max), t && a.splice(1, a.length - 2), b.tickPositions = a);
        ...
        setMaxTicks: function() {
            ...
            !this.isLinked && !this.isDatetimeAxis && c && c.length >
                (b[d] || 0) && !1 !== this.options.alignTicks && (b[d] = c.length);
            a.maxTicks = b
        },
        ...
        zoom: function(a, b) {
            ...
            this.allowZoomOutside ||
                (u(c) && a <= U(c, p(e.min, c)) && (a = G), u(d) && b >= N(d, p(e.max, d)) && (b = G));
        ...
        getOffset: function() {
            ...
            if (q || a.isLinked) {
                ...
                if (a.horiz && !a.staggerLines && B && !k.rotation) {
                    for (q = a.reversed ? [].concat(e).reverse() : e; n < B;) {
                        R = [];
                        y = !1;
                        for (F = 0; F < q.length; F++) w = q[F], J = (J = f[w].label && f[w].label.getBBox()) ? J.width : 0, C = F %
                            n, J && (w = a.translate(w), R[C] !== G && w < R[C] && (y = !0), R[C] = w + J);
                        if (y) n++;
                        else break
                    }
            ...
            H && H.text && !1 !== H.enabled && (a.axisTitle || (a.axisTitle = c.text(H.text, 0, 0, H.useHTML).attr({
                ...
                this.coll.toLowerCase() + "-title").css(H.style).add(a.axisGroup), a.axisTitle.isNew = !0), r && (v = a.axisTitle.getBBox()[g ? "height" : "width"], z = H.offset, x = u(z) ? 0 : p(H.margin, g ? 5 : 10)), a.axisTitle[r ? "show" : "hide"]());
        ...
        getTitlePosition: function() {
            var a = this.horiz,
                ...
                b = (a ? c + this.height : b) + (a ? 1 : -1) * (g ? -1 : 1) * this.axisTitleMargin + (2 === this.side ? m :
                    0);
            return {
        ...
        render: function() {
            ...
            if (F || h) a.minorTickInterval && !a.categories && D(a.getMinorTickPositions(), function(b) {
                ...
                (v[-1] = new ra(a, -1, null, !0)), v[-1].render(-1))), p && D(m, function(b, c) {
    ...
    T.prototype.getTimeTicks = function(a, b, c, d) {
        ...
        if (u(b)) {
            q >= ba.second &&
                (m.setMilliseconds(0), m.setSeconds(q >= ba.minute ? 0 : r * fa(m.getSeconds() / r)));
    ...
    Hb.prototype = {
        ...
        hide: function(a) {
            var b = this,
                c;
            clearTimeout(this.hideTimer);
            this.isHidden || (c = this.chart.hoverPoints,
        ...
        getAnchor: function(a, b) {
            ...
            c || (D(a, function(a) {
                ...
                a.length, c = [e ? d.plotWidth - h : g, this.shared && !e && 1 < a.length && b ? b.chartY - f : e ? d.plotHeight - g : h]);
            return Fa(c, L)
        },
    ...
    var Ga;
    db = Z.documentElement.ontouchstart !==
        G;
    ...
    Ta.prototype = {
        ...
        runPointActions: function(a) {
            ...
            if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
                f = [];
                m = c.length;
                for (q = 0; q < m; q++) c[q].visible && !1 !== c[q].options.enableMouseTracking && !c[q].noSharedTooltip && !0 !== c[q].singularTooltips && c[q].tooltipPoints.length && (e = c[q].tooltipPoints[v]) && e.series && (e._dist = ka(v - e.clientX),
                    r = U(r, e._dist), f.push(e));
        ...
        drag: function(a) {
            ...
            10 < this.hasDragged && (v = b.isInsidePlot(z - h, x - m), b.hasCartesianSeries && (this.zoomX || this.zoomY) && v && !H && !this.selectionMarker && (this.selectionMarker = b.renderer.rect(h, m, f ? 1 : q, g ? 1 : r, 0).attr({
                    ...
                    zIndex: 7
                }).add()), this.selectionMarker &&
                f && (d -= z, this.selectionMarker.attr({
                    width: ka(d),
                    x: (0 < d ? 0 : d) + z
    ...
    n(ga.Pointer.prototype, {
        ...
        pinch: function(a) {
            var b = this,
                ...
                q = b.selectionMarker,
                r = {},
                v = 1 === g && (b.inClass(a.target, "highcharts-tracker") && c.runTrackerClick || b.runChartClick),
                z = {};
        ...
        onContainerTouchStart: function(a) {
            var b = this.chart;
            Ga = b.index;
            1 === a.touches.length ? (a = this.normalize(a), b.isInsidePlot(a.chartX -
    ...
    ub.prototype = {
        init: function(a, b) {
            ...
            b.enabled && (c.itemStyle = d, c.itemHiddenStyle =
                E(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.symbolWidth = p(b.symbolWidth, 16), c.pages = [], c.render(), W(c.chart, "endResize", function() {
        ...
        renderItem: function(a) {
            ...
            A || (a.legendGroup = c.g("legend-item").attr({
                ...
                align: v ? "left" : "right",
                zIndex: 2
            }).add(a.legendGroup), this.baseline || (this.baseline = c.fontMetrics(h.fontSize, A).f + 3 + k, A.attr("y", this.baseline)), F.drawLegendSymbol(this,
                a), this.setItemEvents && this.setItemEvents(a, A, B, h, m), this.colorizeItem(a, a.visible), n && this.createCheckboxForItem(a));
            c = A.getBBox();
    ...
    na.prototype = {
        ...
        cloneRenderTo: function(a) {
            var b = this.renderToClone,
                c = this.container;
            a ? b && (this.renderTo.appendChild(c), Va(b), delete this.renderToClone) : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone =
                b = this.renderTo.cloneNode(0), I(b, {
                    position: "absolute",
                    top: "-9999px",
                    display: "block"
        ...
        getMargins: function() {
            ...
            c.display && !e.floating && ("right" === m ? u(d[1]) || (this.marginRight = N(this.marginRight, c.legendWidth - g + f + a[1])) : "left" === m ? u(d[3]) || (this.plotLeft = N(this.plotLeft, c.legendWidth + g + f + a[3])) :
                "top" === q ? u(d[0]) || (this.plotTop = N(this.plotTop, c.legendHeight + h + f + a[0])) : "bottom" !== q || u(d[2]) || (this.marginBottom = N(this.marginBottom, c.legendHeight - h + f + a[2])));
        ...
        firstRender: function() {
            ...
            a.isReadyToRender() && (a.getContainer(), ja(a, "init"), a.resetMargins(), a.setChartSize(), a.propFromSeries(), a.getAxes(), D(b.series || [], function(b) {
                    a.initSeries(b)
                }), a.linkSeries(), ja(a, "beforeRender"), ga.Pointer && (a.pointer = new Ta(a, b)), a.render(), a.renderer.draw(),
                c && c.apply(a, [a]), D(a.callbacks, function(b) {
                    b.apply(a, [a])
    ...
    Da.prototype = {
        ...
        applyOptions: function(a, b) {
            ...
            a = Da.prototype.optionsToObject.call(this,
                a);
            n(this, a);
    ...
    V.prototype = {
        ...
        processData: function(a) {
            ...
            for (m = b.length - 1; 0 <=
                m; m--) d = b[m] - b[m - 1], !f && b[m] > x && b[m] < z && r++, 0 < d && (g === G || d < g) ? g = d : 0 > d && this.requireSorting && Aa(15);
            this.cropped = f;
            this.cropStart = e;
        ...
        translate: function() {
            ...
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, m = a.pointPlacement, q = "between" === m || aa(m), r = a.threshold, a = 0; a < g; a++) {
                ...
                b && this.visible && t && t[z] && (t = t[z], x = t.points[this.index + "," + a], k = x[0], x = x[1], 0 === k && (k = p(r, e.min)), e.isLog && 0 >= k && (k = null), v.total = v.stackTotal =
                    t.total, v.percentage = t.total && v.y / t.total * 100, v.stackY = x, t.setOffset(this.pointXOffset || 0, this.barW || 0));
        ...
        getAttribs: function() {
            ...
            b.marker ? (e.radius = e.radius || c.radius + e.radiusPlus, e.lineWidth = e.lineWidth || c.lineWidth + e.lineWidthPlus) : e.color = e.color ||
                Ja(e.color || g).brighten(e.brightness).get();
            ...
            if (!m || g < m || r)
                for (; g--;) {
                    ...
                    r ? (c = c || {}, r = [], d = c.states || {}, f = d.hover = d.hover || {}, b.marker || (f.color = f.color || !m.options.color && e.color || Ja(m.color).brighten(f.brightness ||
                        e.brightness).get()), f = {
                        color: m.color
        ...
        getSegmentPath: function(a) {
            ...
            D(a, function(e, f) {
                ...
                b.getPointSpline ? c.push.apply(c, b.getPointSpline(a, e, f)) : (c.push(f ? "L" : "M"),
                    d && f && (m = a[f - 1], "right" === d ? c.push(m.plotX, h) : "center" === d ? c.push((m.plotX + g) / 2, m.plotY, (m.plotX + g) / 2, h) : c.push(g, m.plotY)), c.push(e.plotX, e.plotY))
            });
            return c
        },
    ...
    V.prototype.setStackedPoints = function() {
        if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
            var a = this.processedXData,
                ...
                z = r.oldStacks,
                x, k, p, t, l, A;
            for (t = 0; t < d; t++) l = a[t], A = b[t], p = this.index + "," + t, k = (x = q && A < f) ? m : h, v[k] || (v[k] = {}), v[k][l] || (z[k] && z[k][l] ? (v[k][l] = z[k][l], v[k][l].total =
                null) : v[k][l] = new Xa(r, r.options.stackLabels, x, l, g)), k = v[k][l], k.points[p] = [k.cum || 0], "percent" === e ? (x = x ? h : m, q && v[x] && v[x][l] ? (x = v[x][l], k.total = x.total = N(x.total, k.total) + ka(A) || 0) : k.total = qa(k.total + (ka(A) || 0))) : k.total = qa(k.total + (A || 0)), k.cum = (k.cum || 0) + (A || 0), k.points[p].push(k.cum), c[t] = k.cum;
    ...
    n(V.prototype, {
        ...
        remove: function(a, b) {
            ...
            a = p(a, !0);
            c.isRemoving ||
                (c.isRemoving = !0, ja(c, "remove", null, function() {
                    c.destroy();
    ...
    var Lb = M(V, {
        ...
        getColumnMetrics: function() {
            ...
            !1 === b.grouping ? m = 1 : D(a.chart.series, function(b) {
                var c = b.options,
                    e = b.yAxis;
                b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos && (c.stacking ? (f = b.stackKey, g[f] === G &&
                    (g[f] = m++), h = g[f]) : !1 !== c.grouping && (h = m++), b.columnIndex = h)
            });
        ...
        translate: function() {
            ...
            D(a.points, function(c) {
                ...
                c.barX = k;
                c.pointWidth = m;
                c.tooltipPos = b.inverted ? [e.len - h, a.xAxis.len -
                    k - t / 2
                ] : [k + t / 2, h + e.pos - b.plotTop];
                t = L(k + t) + v;
                k = L(k) + v;
                t -= k;
                d = .5 > ka(l);
        ...
        drawPoints: function() {
            ...
            D(a.points, function(h) {
                ...
                m === G || isNaN(m) || null === h.y ? q && (h.graphic = q.destroy()) : (f = h.shapeArgs, m = u(a.borderWidth) ? {
                    ...
                    h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], q ? (gb(q), q.attr(m)[b.pointCount < e ? "animate" : "attr"](E(f))) : h.graphic = d[h.shapeType](f).attr(g).attr(m).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius))
            })
        },
        animate: function(a) {
            var b = this.yAxis,
                ...
                e = {};
            wa && (a ? (e.scaleY = .001, a = U(b.pos + b.len, N(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX" : "translateY"] = b.pos, this.group.animate(e,
    ...
    var Mb = {
            ...
            translate: function(a) {
                ...
                for (z = 0; z <
                    ...
                    t.angle = h;
                    e = U(e, v / 2);
                    t.labelPos = [a[0] + f + xa(h) * v, a[1] + g + ya(h) * v, a[0] + f + xa(h) * e, a[1] + g + ya(h) * e, a[0] + f, a[1] + g, 0 > v ? "center" : t.half ?
                        "right" : "left", h
                    ]
                }
            },
    ...
    V.prototype.drawDataLabels = function() {
        var a = this,
            ...
            m, q;
        if (d.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(d), q = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible",
            d.zIndex || 6), p(d.defer, !0) && (q.attr({
            opacity: +h
    ...
    V.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        if (a = this.visible && (a.series.forceDL || f.isInsidePlot(h, L(m), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g))) d = n({
            ...
            align: c.align
        }) : (b.align(c, null, d), g = b.alignAttr, "justify" === p(c.overflow, "justify") ? this.justifyDataLabel(b, c, g, q, d, e) : p(c.crop, !0) && (a = f.isInsidePlot(g.x,
            g.y) && f.isInsidePlot(g.x + q.width, g.y + q.height)));
        a || (b.attr({
            y: -999
        }), b.placed = !1)
    };
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            for (J = 2; J--;) {
                ...
                if (K) {
                    ...
                    if (0 < k) {
                        ...
                        for (C = 0; C < K; C++) {
                            ...
                            if (ca < C && null !== E[C]) ca = C;
                                ...
                                for (n < K - C + ca && null !== E[C] && (ca = n - K + C); null ===
                                    E[ca];) ca++;
                            ea.push({
                                i: ca,
                                y: E[ca]
                    ...
                    for (C = 0; C < K; C++) {
                        ...
                        F.connX = R;
                        F.connY = y;
                        null === this.options.size && (n = F.width, R - n < f ? da[3] = N(L(n - R + f), da[3]) :
                            R + n > h - f && (da[1] = N(L(R + n - h + f), da[1])), 0 > y - b / 2 ? da[0] = N(L(-y + b / 2), da[0]) : y + b / 2 > m && (da[2] = N(L(y + b / 2 - m), da[2])))
                    }
                }
            }
            if (0 === Ia(da) || this.verifyDataLabelOverflow(da)) this.placeDataLabels(), A && g && D(this.points, function(b) {
                ...
                (F = b.dataLabel) && F._pos ? (w = F._attr.visibility, R = F.connX, y = F.connY, r = v ? ["M", R + ("left" === B[6] ? 5 : -5), y, "C", R, y, 2 * B[2] - B[4], 2 * B[3] - B[5], B[2], B[3], "L", B[4], B[5]] : ["M", R + ("left" === B[6] ? 5 : -5), y, "L", B[2], B[3], "L", B[4], B[5]], q ? (q.animate({
                        d: r
                    }), q.attr("visibility", w)) : b.connector =
                    q = a.chart.renderer.path(r).attr({
                        "stroke-width": g,
    ...
    P.scatter && (bc.prototype.drawTracker =
        $a.drawTrackerPoint);
    n(ub.prototype, {
    ...
    n(na.prototype, {
        ...
        zoom: function(a) {
            ...
            b && this.redraw(p(this.options.chart.animation, a && a.animation,
                100 > this.pointCount))
        },
        pan: function(a, b) {
            var c = this,
    ...
    n(Da.prototype, {
        ...
        setState: function(a, b) {
            ...
            if (!(a === this.state && !b || this.selected && "select" !== a || f[a] && !1 === f[a].enabled || a && (q || h && !1 === m.enabled) || a && v.states && v.states[a] && !1 === v.states[a].enabled)) {
                if (this.graphic) g = g && this.graphic.symbolName && p.r, this.graphic.attr(E(p,
                    g ? {
                        x: c - g,
                        y: d - g,
                        width: 2 * g,
            ...
            if (!1 !== this.options.enableMouseTracking && !this.singularTooltips) {
                ...
                for (m = 0; m < a; m++)
                    if (e = b[m], c = e.x, c >= f.min && c <= f.max)
                        for (h = b[m + 1], c = d ===
                            G ? 0 : d + 1, d = b[m + 1] ? U(N(0, fa((e.clientX + (h ? h.wrappedClientX || h.clientX : g)) / 2)), g) : g; 0 <= c && c <= d;) q[c++] = e;
    ...
    k(V.prototype, "init", function(a) {
        ...
        (b = this.xAxis) && b.options.ordinal && W(this, "updatedData",
            function() {
    ...
    n(T.prototype, {
        beforeSetTickPositions: function() {
            ...
            if (this.options.ordinal) {
                ...
                c ? (this.ordinalPositions = b, c = this.val2lin(N(f, b[0]), !0), d = N(this.val2lin(U(e, b[b.length - 1]), !0),
                    1), this.ordinalSlope = e = (e - f) / (d - c), this.ordinalOffset = f - c * e) : this.ordinalPositions = this.ordinalSlope = this.ordinalOffset = G
            }
    ...
    var fc = M(P.column, {
        ...
        drawPoints: function() {
            ...
            D(a.points, function(r) {
                r.plotY !== G && (m = r.graphic, c = r.pointAttr[r.selected ? "selected" : ""] || a.pointAttr[""], f = c["stroke-width"] % 2 / 2, q = L(r.plotX) -
                    f, g = L(r.shapeArgs.width / 2), h = ["M", q, L(r.yBottom), "L", q, L(r.plotY)], null !== r.open && (d = L(r.plotOpen) + f, h.push("M", q, d, "L", q - g, d)), null !== r.close && (e = L(r.plotClose) + f, h.push("M", q, e, "L", q + g, e)), m ? m.animate({
                        d: h
    ...
    var zc = M(fc, {
        ...
        drawPoints: function() {
            ...
            D(a.points, function(A) {
                t = A.graphic;
                A.plotY !== G && (c = A.pointAttr[A.selected ?
                    "selected" : ""] || d, r = c["stroke-width"] % 2 / 2, k = L(A.plotX) - r, e = A.plotOpen, f = A.plotClose, g = la.min(e, f), h = la.max(e, f), l = L(A.shapeArgs.width / 2), m = L(g) !== L(A.plotY), q = h !== A.yBottom, g = L(g) + r, h = L(h) + r, p = ["M", k - l, h, "L", k - l, g, "L", k + l, g, "L", k + l, h, "Z", "M", k, g, "L", k, m ? L(A.plotY) : g, "M", k, h, "L", k, q ? L(A.yBottom) : h], t ? t.animate({
                    d: p
    ...
    P.flags = M(P.column, {
        ...
        translate: function() {
            ...
            D(b, function(c, d) {
                c.plotY === G && (c.x >=
                    q.min && c.x <= q.max ? c.plotY = a.chartHeight - m.bottom - (m.opposite ? m.height : 0) + m.offset - a.plotTop : c.shapeArgs = {});
        ...
        drawPoints: function() {
            var a, b = this.pointAttr[""],
                ...
                p, l;
            for (q = c.length; q--;) r = c[q], a = r.plotX > this.xAxis.len, e = r.plotX + (a ? t : -t), k = r.stackIndex, m = r.options.shape || g.shape, f = r.plotY, f !== G && (f = r.plotY + h + t - (k !== G && k *
                g.stackDistance)), p = k ? G : r.plotX + t, l = k ? G : r.plotY, k = r.graphic, f !== G && 0 <= e && !a ? (a = r.pointAttr[r.selected ? "select" : ""] || b, k ? k.attr({
                x: e,
                y: f,
                r: a.r,
                anchorX: p,
    ...
    ab.prototype = {
        ...
        drawScrollbarButton: function(a) {
            ...
            }).add(d[a]), c.push(g), g = b.path(["M", e / 2 + (a ? -1 : 1), e / 2 - 3, "L", e / 2 + (a ? -1 : 1), e / 2 + 3, e / 2 + (a ? 2 :
                -2), e / 2]).attr({
        ...
        render: function(a, b, c, d) {
            ...
            if (!isNaN(a)) {
                ...
                if (!(k.translate(d, !0) - k.translate(c, !0) < e.xAxis[0].minRange)) {
                    ...
                    this.zoomedMin = N(this.fixedWidth ?
                        this.zoomedMax - this.fixedWidth : U(c, d), 0);
                    ...
                    }).add(k)), F && (this.scrollbarGroup = r = f.g("scrollbar").add(), t = B.trackBorderWidth, this.scrollbarTrack =
                        l = f.rect().attr({
                            x: 0,
                            y: -t % 2 / 2,
        ...
        init: function() {
            ...
            a.mouseDownHandler = function(d) {
                ...
                F > h && F < h + g + q && ((h = !a.scrollbarEnabled || F < h + g) && la.abs(z - e - p) < B ? (a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null) : h && la.abs(z - f - p) < B ? (a.grabbedRight = !0, a.otherHandlePos = e, a.fixedExtreme = d.min, b.fixedRange = null) : z > p + e - A && z < p + f + A ? (a.grabbedCenter = z, a.fixedWidth = x, b.renderer.isSVG && (v = r.cursor, r.cursor = "ew-resize"), m = z - e) : z > k && z < k + t && (f = h ? z - p - x / 2 : z < p ? e - .2 * x : z > k + t - q ? e + .2 * x : z < p + e ? e - x : f, 0 > f ? f = 0 : f + x >= l && (f = l - x, n = c.dataMax), f !== e && (a.fixedWidth = x, e = c.toFixedRange(f, f + x,
                    null, n), d.setExtremes(e.min, e.max, !0, !1, {
                    trigger: "navigator"
                }))))
            };
            a.mouseMoveHandler = function(c) {
                var d = a.scrollbarHeight,
                    ...
                    r = a.range,
                    k;
                0 !== c.pageX && (c = b.pointer.normalize(c), k = c.chartX, k < e ? k = e : k > g + h - d && (k = g + h - d), a.grabbedLeft ? (q = !0, a.render(0, 0, k - e, a.otherHandlePos)) : a.grabbedRight ? (q = !0, a.render(0, 0, a.otherHandlePos, k - e)) : a.grabbedCenter && (q = !0, k < m ? k = m : k > f + m - r && (k = f + m - r), a.render(0, 0, k - m, k - m + r)), q && a.scrollbarOptions.liveRedraw &&
                    setTimeout(function() {
                        a.mouseUpHandler(c)
                    }, 0))
            };
            ...
            a.navigatorEnabled ? (a.xAxis = c = new T(b, E({
                ...
                index: A,
                zoomEnabled: !1
            })), t || f.series.data ? a.addBaseSeries() : 0 === b.series.length && k(b, "redraw",
                function(c, d) {
            ...
            k(b, "getMargins", function(b) {
                var e = this.legend,
                    f = e.options;
                b.call(this);
                a.top = h = a.navigatorOptions.top || this.chartHeight - a.height - a.scrollbarHeight - this.spacing[2] - ("bottom" === f.verticalAlign &&
                    f.enabled && !f.floating ? e.legendHeight + p(f.margin, 10) : 0);
        ...
        setBaseSeries: function(a) {
            ...
            this.baseSeries =
                b.series[a] || "string" === typeof a && b.get(a) || b.series[0];
        ...
        addBaseSeries: function() {
            ...
            a && !1 !== this.navigatorOptions.adaptToUpdatedData && (W(a,
                "updatedData", this.updatedDataHandler), a.userOptions.events = n(a.userOptions.event, {
    ...
    T.prototype.getPlotLinePath = function(a, b, c, d, e) {
        var f = this,
            ...
            n, B;
        if ("xAxis" ===
            f.coll || "yAxis" === f.coll) n = f.isXAxis ? u(f.options.yAxis) ? [h.yAxis[f.options.yAxis]] : Fa(g, function(a) {
            return a.yAxis
    ...
    k(T.prototype, "drawCrosshair", function(a, b, c) {
        var d, e;
        a.call(this, b, c);
        if (u(this.crosshair.label) &&
            this.crosshair.label.enabled && u(c)) {
            e = this.chart;
    ...
    k(V.prototype, "render", function(a) {
        this.chart.options._stock && (!this.clipBox && this.animate && -1 !== this.animate.toString().indexOf("sharedClip") ?
            (this.clipBox = E(this.chart.clipBox), this.clipBox.width = this.xAxis.len, this.clipBox.height = this.yAxis.len) : this.chart[this.sharedClipKey] && this.chart[this.sharedClipKey].attr({
    ...
    var xb = T.prototype,
        ...
        gc = {
            ...
            setAxisSize: function() {
                ...
                this.isRadial &&
                    (this.center = this.pane.center = ga.CenteredSeriesMixin.getCenter.call(this.pane), this.isCircular && (this.sector = this.endAngleRad - this.startAngleRad), this.len = this.width = this.height = this.center[2] * p(this.sector, 1) / 2)
            },
            ...
            getPlotBandPath: function(a, b, c) {
                ...
                "polygon" === this.options.gridLineInterpolation ? d = this.getPlotLinePath(a).concat(this.getPlotLinePath(b, !0)) : (a = Math.max(a, this.min), b = Math.min(b, this.max), q || (g[0] = this.translate(a), g[1] = this.translate(b)), g = Fa(g, function(a) {
                    ...
                    return a
                }), "circle" !== c.shape && q ? (a = e + this.translate(a), b = e +
                    this.translate(b)) : (a = -Math.PI / 2, b = 1.5 * Math.PI, m = !0), d = this.chart.renderer.symbols.arc(this.left + d[0], this.top + d[1], g[0], g[0], {
                    start: Math.min(a, b),
                    end: Math.max(a, b),
            ...
            getPlotLinePath: function(a, b) {
                ...
                c.isCircular ? m = ["M", d[0] + e.plotLeft, d[1] + e.plotTop, "L", f.x, f.y] : "circle" === c.options.gridLineInterpolation ? (a = c.translate(a)) && (m = c.getLinePath(0, a)) : (D(e.xAxis, function(a) {
                    ...
                    c.translate(a), d = g.tickPositions, g.autoConnect && (d = d.concat([d[0]])), b && (d = [].concat(d).reverse()), D(d, function(b, c) {
                        h = g.getPosition(b, a);
    ...
    k(xb, "init", function(a, b, c) {
        ...
        var q = c.pane || 0;
        if (d) {
            if (n(this, g ? Dc : gc), h = !f) this.defaultRadialOptions =
        ...
        a.call(this, b, c);
        g || !d && !e || (a = this.options, b.panes || (b.panes = []), this.pane = q = b.panes[q] = b.panes[q] || new Ub(w(m.pane)[q], b, this), q = q.options, b.inverted = !1, m.chart.zoomType = null, this.startAngleRad = b = (q.startAngle - 90) * Math.PI / 180, this.endAngleRad = m = (p(q.endAngle, q.startAngle + 360) - 90) * Math.PI / 180, this.offset = a.offset || 0, (this.isCircular =
            h) && c.max === G && m - b === 2 * Math.PI && (this.autoConnect = !0))
    });
    ...
    k(Ob, "getLabelPosition", function(a, b, c, d, e, f, g, h, m) {
        ...
        q.isRadial ? (a = q.getPosition(this.pos, q.center[2] / 2 + p(f.distance, -25)), "auto" === f.rotation ? d.attr({
            rotation: A
        }) : null === k && (k = q.chart.renderer.fontMetrics(d.styles.fontSize).b -
            d.getBBox().height / 2), null === l && (q.isCircular ? (this.label.getBBox().width > q.len * q.tickInterval / (q.max - q.min) && (t = 0), l = A > t && A < 180 - t ? "left" : A > 180 + t && A < 360 - t ? "right" : "center") : l = "center", d.attr({
            align: l
        ...
        getSegments: function() {
            ...
            D(a.points, function(b) {
                a.options.connectNulls ||
                    null !== b.low && null !== b.high ? null === b.low && null !== b.high && (b.y = b.high) : b.y = null
            });
    ...
    P.boxplot = M(P.column, {
        ...
        drawPoints: function() {
            ...
            D(b, function(b) {
                ...
                y = {};
                I = b.color || a.color;
                b.plotY !== G && (e = b.pointAttr[b.selected ? "selected" : ""], w = E.width, C = fa(E.x), J = C + w, da = L(w / 2), f = fa(ea ? b.q1Plot : b.lowPlot), g = fa(ea ? b.q3Plot : b.lowPlot), h = fa(b.highPlot), m = fa(b.lowPlot), F.stroke = b.stemColor || c.stemColor || I, F["stroke-width"] = p(b.stemWidth, c.stemWidth, c.lineWidth),
                    F.dashstyle = b.stemDashStyle || c.stemDashStyle, u.stroke = b.whiskerColor || c.whiskerColor || I, u["stroke-width"] = p(b.whiskerWidth, c.whiskerWidth, c.lineWidth), y.stroke = b.medianColor || c.medianColor || I, y["stroke-width"] = p(b.medianWidth, c.medianWidth, c.lineWidth), r = F["stroke-width"] % 2 / 2, t = C + da + r, A = ["M", t, g, "L", t, h, "M", t, f, "L", t, m], ea && (r = e["stroke-width"] % 2 / 2, t = fa(t) + r, f = fa(f) + r, g = fa(g) + r, C += r, J += r, n = ["M", C, g, "L", C, f, "L", J, f, "L", J, g, "L", C, g, "z"]), ca && (r = u["stroke-width"] % 2 / 2, h += r, m += r, B = ["M", t - da * ca, h, "L", t +
                        da * ca, h, "M", t - da * ca, m, "L", t + da * ca, m
                    ]), r = y["stroke-width"] % 2 / 2, k = L(b.medianPlot) + r, R = ["M", C, k, "L", J, k], l ? (b.stem.animate({
                        d: A
    ...
    P.waterfall = M(P.column, {
        ...
        translate: function() {
            ...
            d = this.points;
            c = 0;
            for (a = d.length; c < a; c++) e = d[c], h = this.processedYData[c], f = e.shapeArgs, r = (g = l && b.stacks[(this.negStacks && h < t ? "-" : "") + this.stackKey]) ? g[e.x].points[this.index + "," + c] : [0, h], e.isSum ? e.y = h : e.isIntermediateSum && (e.y = h - k), g = N(m, m + e.y) + r[0], f.y =
                b.translate(g, 0, 1), e.isSum ? (f.y = b.translate(r[1], 0, 1), f.height = b.translate(r[0], 0, 1) - f.y) : e.isIntermediateSum ? (f.y = b.translate(r[1], 0, 1), f.height = b.translate(k, 0, 1) - f.y, k = r[1]) : (0 !== m && (f.height = 0 < h ? b.translate(m, 0, 1) - f.y : b.translate(m, 0, 1) - b.translate(m - h, 0, 1)), m += h), e.plotY = f.y = L(f.y) - this.borderWidth % 2 / 2, f.height = N(L(f.height), .001), e.yBottom = f.y + f.height, f = e.plotY + (e.negative ? f.height : 0), this.chart.inverted ? e.tooltipPos[0] = b.len - f : e.tooltipPos[1] = f
        },
        processData: function(a) {
            var b = this.yData,
                c =
        ...
        getGraphPath: function() {
            var a = this.data,
                ...
                d = [],
                e, f, g;
            for (g = 1; g < b; g++) f = a[g].shapeArgs, e = a[g - 1].shapeArgs, f = ["M", e.x + e.width, e.y + c, "L", f.x, e.y + c], 0 > a[g - 1].y && (f[2] +=
                e.height, f[5] += e.height), d = d.concat(f);
            return d
        },
        getExtremes: ma,
    ...
    T.prototype.beforePadding = function() {
        var a = this,
            ...
            h = this.min,
            m = {},
            k = la.min(c.plotWidth, c.plotHeight),
            r = Number.MAX_VALUE,
            t = -Number.MAX_VALUE,
            l = this.max - h,
            A = b / l,
        ...
        D(this.series, function(b) {
            ...
            !b.bubblePadding || !b.visible && c.options.chart.ignoreHiddenSeries || (a.allowZoomOutside = !0, F.push(b), f && (D(["minSize", "maxSize"], function(a) {
                    var b = d[a],
                        ...
                        b = O(b);
                    m[a] = c ? k * b / 100 : b
                }), b.minPxSize = m.minSize, b = b.zData, b.length &&
                (r = p(d.zMin, la.min(r, la.max(ea(b), !1 === d.displayNegative ? d.zThreshold : -Number.MAX_VALUE))), t = p(d.zMax, la.max(t, Ia(b))))))
        });
        D(F, function(a) {
            var b = a[g],
                c = b.length,
    ...
    (function() {
        ...
        P.spline && k(P.spline.prototype, "getPointSpline", function(a, b, c, d) {
            var e, k, t, l, p, A, F;
            this.chart.polar ? (e = c.plotX, k = c.plotY, a = b[d - 1], t = b[d + 1], this.connectEnds && (a || (a = b[b.length -
                ...
                k, e, k
            ], a.rightContX = a.rightContY = null) : c = ["M", e, k]) : c = a.call(this, b, c, d);
            return c
        });
        ...
        k(c, "animate", b);
        P.column && (e = P.column.prototype, k(e, "animate",
            b), k(e, "translate", function(a) {
            var b = this.xAxis,
                c = this.yAxis.len,
                d = b.center,
                e = b.startAngleRad,
            ...
            this.chart.polar ? (a = b.rectPlotX / Math.PI *
                180, null === e.align && (e.align = 20 < a && 160 > a ? "left" : 200 < a && 340 > a ? "right" : "center"), null === e.verticalAlign && (e.verticalAlign = 45 > a || 315 < a ? "bottom" : 135 < a && 225 > a ? "top" : "middle"), c.alignDataLabel.call(this, b, d, e, k, r)) : a.call(this, b, d, e, k, r)
        }));
        k(d, "getCoordinates", function(a, b) {
            ...
            c.polar ? D(c.axes, function(a) {
                ...
                d[e ? "xAxis" : "yAxis"].push({
                    axis: a,
                    value: a.translate(e ? Math.PI - Math.atan2(k, f) : Math.sqrt(Math.pow(k,
                        2) + Math.pow(f, 2)), !0)
                })
            }) : d = a.call(this, b);
            return d
...
(function(n) {
    ...
    Y.funnel = n.extendClass(Y.pie, {
        ...
        translate: function() {
            var l = function(k, t) {
                    return /%$/.test(k) ? t * parseInt(k, 10) / 100 : parseInt(k,
                        10)
                },
                n = 0,
                B = this.chart,
...
(function(n) {
    ...
    u(E.prototype, {
        sanitizeSVG: function(k) {
            return k.replace(/zIndex="[^"]+"/g, "").replace(/isShadow="[^"]+"/g, "").replace(/symbolName="[^"]+"/g, "").replace(/jQuery[0-9]+="[^"]+"/g, "").replace(/url\([^#]+#/g, "url(#").replace(/<svg /, '<svg xmlns:xlink="http://www.w3.org/1999/xlink" ').replace(/ (NS[0-9]+\:)?href=/g,
                ...
                'height="$1"').replace(/width=([^" ]+)/g, 'width="$1"').replace(/hc-svg-href="([^"]+)">/g, 'xlink:href="$1"/>').replace(/id=([^" >]+)/g, 'id="$1"').replace(/class=([^" >]+)/g, 'class="$1"').replace(/ transform /g, " ").replace(/:(path|rect)/g, "$1").replace(/style="([^"]+)"/g, function(k) {
        ...
        print: function() {
            ...
            k.isPrinting || (k.isPrinting = !0, Q(k, "beforePrint"), y(B, function(k, t) {
                1 === k.nodeType && (l[t] =
                    k.style.display, k.style.display = "none")
    ...
    M.menu = function(k, t, l, p) {
        return ["M", k, t + 2.5, "L", k + l, t + 2.5, "M", k, t + p / 2 + .5, "L", k + l, t + p / 2 + .5, "M",
            k, t + p - 1.5, "L", k + l, t + p - 1.5
        ]
    };
    ...
    n.extend(aa.prototype, {
        ...
        getColumnDistribution: function() {
            ...
            E(l && l.seriesMapping || [], function(l) {
                ...
                for (A in l) l.hasOwnProperty(A) &&
                    "x" !== A && J.addColumnReader(l[A], A);
        ...
        parseGoogleSpreadsheet: function() {
            ...
            y && jQuery.ajax({
                ...
                success: function(l) {
                    ...
                    for (y = 0; y < k; y++) A = l[y], K = A.gs$cell.row -
                        1, M = A.gs$cell.col - 1, M >= p && M <= E && K >= C && K <= w && (u[M - p][K - C] = A.content.$t);
                    n.dataFound()
                }
            })
        },
        ...
        parseColumn: function(n, l) {
            ...
            for (y[l] || (y[l] = []); C--;) w = A[C] || n[C], E = this.trim(w), K = this.trim(w, !0), p = parseFloat(K), void 0 === y[l][C] && (y[l][C] = E), k || 0 === C && M ? n[C] = E : +K === p ? (n[C] = p, 31536E6 < p && "float" !== F ? n.isDatetime = !0 : n.isNumeric = !0, void 0 !== n[C + 1] && (t = p > n[C + 1])) : (p = this.parseDate(w), J && "number" === typeof p && !isNaN(p) && "float" !== F ? (A[C] = w, n[C] = p, n.isDatetime = !0, void 0 !== n[C + 1] && (w = p > n[C + 1], w !== t && void 0 !==
                t && (this.alternativeFormat ? (this.dateFormat = this.alternativeFormat, C = n.length, this.alternativeFormat = this.dateFormats[this.dateFormat].alternative) : n.unsorted = !0), t = w)) : (n[C] = "" === E ? null : E, 0 !== C && (n.isDatetime || n.isNumeric) && (n.mixed = !0)));
            J && n.mixed && (u[l] = y[l]);
...
(function(n) {
    ...
    n.SVGRenderer.prototype.Element.prototype.fadeIn =
        function(l) {
            this.attr({
                opacity: .1,
                visibility: "inherit"
    ...
    y.prototype.addSingleSeriesAsDrilldown = function(l, k) {
        ...
        Q(t.chart.series, function(k) {
            k.xAxis === n && (y.push(k), k.options._ddSeriesId =
                k.options._ddSeriesId || M++, k.options._colorIndex = k.userOptions._colorIndex, C.push(k.options), k.options._levelNumber = k.options._levelNumber || B)
        });
        u = {
            levelNumber: B,
    ...
    y.prototype.getDrilldownBackText =
        function() {
            var l = this.drilldownLevels;
    ...
    n.Point.prototype.doDrilldown = function(l, k) {
        for (var t = this.series.chart, n = t.options.drilldown, u = (n.series || []).length, w; u-- && !w;) n.series[u].id === this.drilldown && -1 ===
            I(this.drilldown, K) && (w = n.series[u], K.push(this.drilldown));
        p(t, "drilldown", {
            point: this,
            seriesOptions: w,
            category: k,
    ...
    l(n.Point.prototype, "init", function(l, k, t, p) {
        ...
        u.drilldown ? (n.addEvent(u, "click", function() {
            ...
            }), t.ddPoints.push(u), t.levelNumber = k.options._levelNumber)) : t && t.basicStyles && t.levelNumber !==
            k.options._levelNumber && (t.styles = {}, t.css(t.basicStyles), t.on("click", null));
        return u
    });
        ...
        toColor: function(n, B) {
            ...
            if (C)
                for (p = C.length; p--;) {
                    ...
                    y = y[p + 1] || u;
                    l = 1 - (y[0] - l) / (y[0] - u[0] || 1);
                    l = this.tweenColors(u.color, y.color,
                        l)
                }
            return l
        },
    ...
    n.seriesTypes.solidgauge = n.extendClass(n.seriesTypes.gauge, {
        ...
        drawPoints: function() {
            ...
            n.each(E.points, function(n) {
                var w = n.graphic,
                    M = B.startAngleRad + B.translate(n.y,
                        null, null, null, !0),
...
(function(n) {
    ...
    y(M.prototype, {
        ...
        tweenColors: function(l, p, k) {
            ...
            return (t ? "rgba(" : "rgb(") +
                Math.round(p[0] + (l[0] - p[0]) * (1 - k)) + "," + Math.round(p[1] + (l[1] - p[1]) * (1 - k)) + "," + Math.round(p[2] + (l[2] - p[2]) * (1 - k)) + (t ? "," + (p[3] + (l[3] - p[3]) * (1 - k)) : "") + ")"
        },
        initDataClasses: function(n) {
            ...
            l(n.dataClasses, function(l, n) {
                ...
                l = C(l);
                t.push(l);
                l.color || ("category" === w.dataClassColor ? (y = k.options.colors, l.color = y[u++], u === y.length && (u = 0)) : l.color = p.tweenColors(Y(w.minColor), Y(w.maxColor), 2 > B ? .5 : n / (B -
                    1)))
            })
        },
        ...
        setAxisSize: function() {
            var l = this.legendSymbol,
                n = this.chart,
                k, t, p;
            l && (this.left = k = l.attr("x"), this.top = t = l.attr("y"), this.width = p = l.attr("width"), this.height = l = l.attr("height"), this.right = n.chartWidth - k - p, this.bottom = n.chartHeight -
                t - l, this.len = this.horiz ? p : l, this.pos = this.horiz ? k : t)
        },
        ...
        getSeriesExtremes: function() {
            var l;
            this.series.length && (l = this.series[0], this.dataMin = l.valueMin, this.dataMax =
                l.valueMax)
        },
        ...
        getPlotLinePath: function(l, n, k, t, p) {
            return p ? this.horiz ? ["M", p - 4, this.top - 6, "L", p + 4, this.top - 6, p, this.top, "Z"] : ["M", this.left, p, "L", this.left - 6, p + 6, this.left - 6, p - 6, "Z"] :
                E.prototype.getPlotLinePath.call(this, l, n, k, t)
        },
        update: function(n, p) {
    ...
    p.heatmap = u(p.scatter, C(O, {
        ...
        translate: function() {
            ...
            this.chart.hasRendered && l(this.points,
                function(k) {
