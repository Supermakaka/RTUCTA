...
namespace WebSite.Core.Providers
{
    public class CustomMembershipProvider : MembershipProvider
    {
        ...
        {
            //Do not inject into constructor as Membership Provider is a static instance, but DbContext is per request
            //Get the instance using DependencyResolver instead
